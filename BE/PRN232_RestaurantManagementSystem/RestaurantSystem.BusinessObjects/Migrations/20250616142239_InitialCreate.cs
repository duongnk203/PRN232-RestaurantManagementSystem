    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemCategories", x => new { x.ItemID, x.CategoryID });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_MenuItemCategories_MenuItems_ItemID",
                        column: x => x.ItemID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_OrderType", "OrderType IN ('DineIn', 'TakeAway')");
                    table.CheckConstraint("CHK_PaymentMethod", "PaymentMethod IN ('Cash', 'Online')");
                    table.ForeignKey(
